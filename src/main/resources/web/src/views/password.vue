<template>
  <div class="container">
    <div class="registerForm">
      <div class="division"><h3>忘记密码</h3>
      <h3 style="color: #888;font-weight: 400">--- PASSWORD ---</h3></div>
      <el-form :model="registerInfo" status-icon :rules="registerrules" ref="registerInfo" label-width="100px"
        ...
        <el-form-item prop="check">
          ...
          <el-form-item>
            <el-button type="primary" class="registerBtn" @click="registerSubmit('registerInfo')">修改密码</el-button>
          </el-form-item>
      </el-form>
    ...
    registerSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          fetch
            .updatePassOfEmail(user, this.registerInfo.check)
            .then((res) => {
              if (res.status === 200) {
                if (res.data.code === "00000") {
                  this.$message({
